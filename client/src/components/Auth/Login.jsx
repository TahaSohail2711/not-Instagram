  ...
  return (
    <div className='login flex flex-col items-center justify-center text-white min-h-screen'>
      ...
      <div className='w-full max-w-md'>
        <form className='bg-opacity-40 rounded-xl border-2 border-white shadow-md px-8 pt-6 pb-8 mb-4'>
          <div className='mb-4'>
            <label
          ...
          <div className='mb-6'>
            ...
            <input
              className={`appearance-none border border-b-4 bg-slate-900 ${
          ...
          <div className='flex items-center justify-center'>
            <button
              className='bg-transparent hover:bg-white text-white hover:text-black font-bold py-2 px-4 border-2 border-b-4 border-white hover:border-white rounded-xl'
              type='submit'
              onClick={submit}
            >
              Login
